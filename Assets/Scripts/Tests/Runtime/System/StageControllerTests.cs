...
namespace Tests.Runtime.System
{
    ...
    public class StageControllerTests
    {
         ...
         { 
             ...
             Ch1StageChanger stageChanger = new Ch1StageChanger(player.transform, new Stage[] {stage1, stage2}, null, null);
             
             //Action
             stageController.Init(null, null, null);
             
             var task = stageChanger.SwitchStage(2, new Vector2(0, 0));
